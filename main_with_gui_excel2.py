...
def start_recognition():
    ...
    while True:
        ...
        # coordinates at which coordinate the camera frame will be fitting
        ...
        if faceCurFrame:
            for encodeFace, faceLoc in zip(encodeCurFrame, faceCurFrame):
                ...
                if matches[matchIndex]:
                    ...
                    # bbox  bounding box is a rectangular box that encompasses an object or a region of
                    ...
                    if can_mark_attendance(id):
                        ...
                        cv2.imshow("Face Reorganisation", imgBackground)
                        cv2.waitKey(1)
                        counter = 1
                        modeType = 1
...
root = tk.Tk()
root.title("Face Recognition System by Arnab Adhikary")
